...
import { I18n, setLocale, loadTranslations } from 'react-redux-i18n';
import PropTypes from 'prop-types';
import photo from '../../../images/omnie.png';
import {languages, translationObject} from '../../dictionary/translations';
...
class LanguageSwitcherComponent extends Component {
    render() {       
        console.log('render', this.props.language);
        let langs = languages.map( (current) => {
            ...
            return <li className="languageSwitcherStyle" onClick={ () => {
